...
# Perform label encoding for non-numeric variables
encoded_data <- res
non_numeric_vars <- c("Gender", "Academic Program", "Degree", "University", "Social Media", "Activity")

for (var in non_numeric_vars) {
  encoded_data[[var]] <- as.numeric(as.factor(encoded_data[[var]]))
}
